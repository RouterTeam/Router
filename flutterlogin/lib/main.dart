...
import 'package:flutterlogin/pages/groupmore_page.dart';
...
Widget chooseWidget(String routeName) {
  if (routeName.startsWith("login")) return LoginPage();
  else if (routeName.startsWith("group_more")){
    List<String> listParams = routeName.split("/");
    return GroupMorePage(listParams[1],listParams[2]);
  }
